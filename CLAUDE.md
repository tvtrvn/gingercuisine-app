...
This project is indexed by GitNexus as **gingercuisine-app** (1089 symbols, 2415 relationships, 87 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
