...
This project is indexed by GitNexus as **gingercuisine-app** (1051 symbols, 2336 relationships, 84 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
